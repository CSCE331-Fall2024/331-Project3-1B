            ...
            <div id="header-container">
                ...
                {currURL.includes("cashier") ? (
                    ...
                    <div id="buttons-header">
                        ...
                        <button onClick={() => {back();playSound('/Sounds/ButtonSound.mp3')}} id='back-button'>
                            <p className="back-button-title"><img src="/Images/Icons/Home.png" className="header-icons"/>Login</p>
                        </button>

                        <button onClick={() => {goToMyBag();playSound('/Sounds/ButtonSound.mp3')}} id="header-button">
                            <p className="header-button-title"><img src="/Images/Icons/Cart.png" className="header-icons"/>My Bag</p>
                        </button>
