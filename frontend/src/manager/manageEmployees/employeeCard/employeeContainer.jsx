...
function EmployeeContainer() {
    ...
    useEffect(() => {
        fetch(`https://three31-project3-1b-backend.onrender.com/manager/get_all_employees`)
    ...
    const removeEmployee = async (index) => {
        ...
        try {
            const response = await fetch(`https://three31-project3-1b-backend.onrender.com/manager/remove_employee/${employeeID}`, {
                method: 'DELETE',
            });
            if (response.ok) {
